...
BATCH_SIZE = 4000
RATIO_NEUTRAL = 10.0 / 11.0   # 中性/总粒子比例
MAX_STEPS = 3200
STEP_LEN = 1.10
DISPLAY_EVERY = 50
MAX_HISTORY = 90
...
ION_SIGMA_DEG = 3.0
NEUTRAL_SIGMA_DEG = 10.0

# 2) 离子：保留各向异性向下刻蚀，但允许反射离子继续参与侧壁/底部作用
ION_BASE_ETCH = 0.12
ION_CL_BOOST = 0.22
ION_MASK_FACTOR = 0.15
ION_REFLECT_FACTOR_1 = 0.60
ION_REFLECT_FACTOR_2 = 0.35

# 3) 中性粒子：降低“直接反射走人”，增强吸附 + 饱和后化学刻蚀
NEUTRAL_REFLECT_BASE = 0.25
NEUTRAL_REFLECT_CL_GAIN = 0.10
NEUTRAL_REFLECT_MASK_GAIN = 0.15
NEUTRAL_REFLECT_CAP = 0.75
ADSORB_BASE = 0.35
MASK_ADSORB_FACTOR = 0.25
MAX_CL_COVERAGE = 4
